...
export function CrystalDragon({ greeting = false }: { greeting?: boolean }) {
  ...
  useEffect(() => {
    ...
    atlas.src = `${import.meta.env.BASE_URL}art/camp/crystal-dragon-idle-v1.webp`
  ...
  return <div
    ...
    style={{ backgroundImage: `url(${import.meta.env.BASE_URL}art/camp/${ready ? 'crystal-dragon-idle-v1' : 'crystal-dragon-idle-poster-v1'}.webp)` }}
  />
}
