...
/** Sixteen registered, individually drawn poses. No whole-image bob or rotation. */
export function CrystalDragon({ greeting = false }: { greeting?: boolean }) {
  ...
  useEffect(() => {
    ...
    atlas.src = `${import.meta.env.BASE_URL}art/camp/crystal-dragon-motion-v3.webp`
  ...
  return <div
    ...
    style={{ backgroundImage: `url(${import.meta.env.BASE_URL}art/camp/${ready ? 'crystal-dragon-motion-v3' : 'crystal-dragon-poster-v3'}.webp)` }}
  />
}
