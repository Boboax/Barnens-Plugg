...
const STATIONS: {id:Exclude<View,'camp'>;name:string;hint:string;x:number;y:number}[]=[
 {id:'pets',name:'Husdjurshuset',hint:'Dina vänner och deras sovplatser',x:48,y:45},
...
export function PetHomeScreen(){
 ...
 const [renameId,setRenameId]=useState(''),[rename,setRename]=useState(''),[outfitPreview,setOutfitPreview]=useState<string>()
