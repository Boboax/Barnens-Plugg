  ...
  return <main className="character-demo">
    <div className="character-demo__inner">
      ...
      <div className="character-demo__grid">
        ...
        <section className="character-demo__panel">
          <h2>{view === 'figure' ? 'Posprov' : view === 'battle' ? 'Rätt/fel-reaktion' : poseSequence === 'guard' ? 'Fel svar · säker undanmanöver' : poseSequence === 'victory' ? 'Seger · svärdet följer handen' : `${isSwordMotion ? 'Svärdssekvens' : 'Bågsekvens'} · samma fas för båda kläderna`}</h2>
          {view === 'motion' ? <>
